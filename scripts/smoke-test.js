 ...
 * Usage: node scripts/smoke-test.js [--base-url https://printdrop-api-production.up.railway.app]
 *
...
const BASE_URL = baseUrlIdx !== -1 ? args[baseUrlIdx + 1] : 'https://printdrop-api-production.up.railway.app';
