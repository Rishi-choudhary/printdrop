...
const variants = {
  ...
  white: 'bg-white text-blue-700 hover:bg-blue-50 focus:ring-blue-300',
  'ghost-white': 'bg-transparent text-white/80 hover:text-white hover:bg-white/10 focus:ring-white/30',
};
